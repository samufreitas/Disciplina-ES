...
var EventSource = /** @class */ (function (_super) {
    ...
    // can we do away with calendarteste? at least for the abstract?
...
// the minor version of the calendarteste should be upped (ex: 2.7.2 -> 2.8.0)
...
// options that should be computed off live calendarteste options (considers override options)
...
var EventDefDateMutation = /** @class */ (function () {
    ...
    */
    EventDefDateMutation.prototype.buildNewDateProfile = function (eventDateProfile, calendar) {
        ...
        // TODO: okay to access calendarteste option?
...
var InteractiveDateComponent = /** @class */ (function (_super) {
    ...
    InteractiveDateComponent.prototype.isExternalInstanceGroupAllowed = function (eventInstanceGroup) {
        ...
        for (i = 0; i < eventFootprints.length; i++) {
            ...
            //  because we don't want calendarteste's constraint system to depend on a component's
...
var View = /** @class */ (function (_super) {
    ...
    ------------------------------------------------------------------------------------------------------------------*/
    // Computes what the title at the top of the calendarteste should be for this view
    ...
    ------------------------------------------------------------------------------------------------------------------*/
    // Must be called when an external element, via jQuery UI, has been dropped onto the calendarteste.
...
var DayTableMixin = /** @class */ (function (_super) {
    ...
    // Intro means the leftmost cell when the calendarteste is LTR and the rightmost cell when RTL. Vice-versa for outro.
...
var DayGrid = /** @class */ (function (_super) {
    ...
    DayGrid.prototype.renderNumberCellHtml = function (date) {
        ...
        if (this.cellWeekNumbersVisible) {
            ...
            // dow, because that would affect the calendarteste start day as well.
...
function isOverlapEventInstancesAllowed(overlapEventFootprints, subjectEventInstance) {
    ...
    for (i = 0; i < overlapEventFootprints.length; i++) {
        ...
        // don't need to pass in calendarteste, because don't want to consider global eventOverlap property,
...
var DateComponent = /** @class */ (function (_super) {
    ...
    // Generates HTML for an anchor to another view into the calendarteste.
...
var Calendar = /** @class */ (function () {
    function Calendar(el, overrides) {
        ...
        // declare the current calendarteste instance relies on GlobalEmitter. needed for garbage collection.
    ...
    Calendar.prototype.getDate = function () {
        return this.applyTimezone(this.currentDate); // infuse the calendarteste's timezone
    };
    // Loading Triggering
    // -----------------------------------------------------------------------------------------------------------------
    ...
    // Builds a moment using the settings of the current calendarteste: timezone and locale.
    ...
    // Updates the given moment's locale settings to the current calendarteste locale settings.
    Calendar.prototype.localizeMoment = function (mom) {
        mom._locale = this.localeData;
    };
    // Returns a boolean about whether or not the calendarteste knows how to calculate
...
var TimeGridEventRenderer = /** @class */ (function (_super) {
    ...
    // from 0 to 1. If the calendarteste is left-to-right, the seg.backwardCoord maps to "left" and
    // seg.forwardCoord maps to "right" (via percentage). Vice-versa if the calendarteste is right-to-left.
    //
...
// Builds an array of segments "levels". The first level will be the leftmost tier of segments if the calendarteste is
// left-to-right, or the rightmost if the calendarteste is right-to-left. Assumes the segments are already ordered by date.
...
var DayGridEventRenderer = /** @class */ (function (_super) {
    ...
    DayGridEventRenderer.prototype.buildSegLevels = function (segs) {
        ...
        // order segments left-to-right. very important if calendarteste is RTL
        for (j = 0; j < levels.length; j++) {
...
$.fn.fullCalendar = function (options) {
    ...
    this.each(function (i, _element) {
        ...
        var calendar = element.data('fullCalendar'); // get the existing calendarteste object (if any)
        ...
        if (typeof options === 'string') {
            if (options === 'getCalendar') {
            ...
            else if (options === 'destroy') { // don't warn if no calendarteste object
                if (calendar) {
                    calendar.destroy();
                ...
                util_1.warn('Attempting to call a FullCalendar method on an element with no calendarteste.');
            }
...
var Toolbar = /** @class */ (function () {
    ...
    // method to update toolbar-specific options, not calendarteste-wide options
            ...
            $.each(buttonStr.split(' '), function (i, buttonGroupStr) {
                ...
                $.each(buttonGroupStr.split(','), function (j, buttonName) {
                    ...
                    if (buttonName === 'title') {
                        ...
                        else if (calendar[buttonName]) { // a calendarteste method
                            buttonClick = function () {
                                calendar[buttonName]();
                            };
...
var OptionsManager = /** @class */ (function (_super) {
    ...
    // Computes the flattened options hash for the calendarteste and assigns to `this.options`.
